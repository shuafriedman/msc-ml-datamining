...
def closure(flows):
	...
	with open('Cyber/SAM-for-Traffic-Classification/protocol_cls/pro_flows_regular.pkl', 'wb') as f:
		pickle.dump(flow_dict, f)
if __name__ == '__main__':
	import os
	print(os.getcwd())
	pcap = dpkt.pcap.Reader(open('Cyber/SAM-for-Traffic-Classification/protocol_cls/202006101400.pcap', 'rb'))
