...
#### "Power", Type 2 error, and Beta ####
# Power is the probability of rejecting the null hypothesis when, in fact, it is false.
##  This is 1 - Beta (Type II Error is failing to reject a false null hypothesis
##  in favor of a true alternative hypothesis. )

#For example, we think the average purchase price at the Library coffee shop is over 
#$3 per student. Our null is $3 or less; our alternative is greater than $3. 
#We can use a one-sample t-test to investigate this hunch. If the true average purchase
# price is $3.50, we would like to have 90% power to declare the estimated average 
# purchase price is greater than $3. How many transactions do we need to observe 
#assuming a significance level of 0.05? Let's say the maximum purchase price is 
#$10 and the minimum is $1. So our guess at a standard deviation is 9/4 = 2.25.
